...
import com.wubydax.romcontrol.v3.utils.AppInfo;
import com.wubydax.romcontrol.v3.utils.AppListTask;
...
public class IntentDialogPreference extends DialogPreference implements
        AdapterView.OnItemClickListener,
        AppListTask.OnListCreatedListener {
    ...
    public IntentDialogPreference(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context
                .obtainStyledAttributes(attrs, R.styleable.IntentDialogPreference);
        mSeparator = typedArray.getString(R.styleable.IntentDialogPreference_intentSeparator);
        mSeparator = mSeparator != null ? mSeparator : "##";
        mIsSearch = typedArray
                .getBoolean(R.styleable.IntentDialogPreference_showSearch, true);
    ...
    protected void onBindView(View view) {
        ...
        ImageView prefAppIcon = view.findViewById(R.id.iconForApp);
    ...
    protected void onBindDialogView(View view) {
        ...
        mListView = view.findViewById(R.id.appsList);
        ...
        if (mIsSearch) {
            EditText search = view.findViewById(R.id.searchApp);
    ...
    private Drawable getAppIcon(String intentString) {
        Drawable appIcon = ResourcesCompat
                .getDrawable(mContext.getResources(), R.mipmap.ic_launcher, null);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        String intentString = String
                .format("%1$s%2$s%3$s", appInfo.mPackageName, mSeparator, Objects
                        .requireNonNull(ri).activityInfo.name);
        setSummary(appInfo.mAppName);
    ...
    @Override
    public void onListCreated(List<com.wubydax.romcontrol.v3.utils.AppInfo> appInfoList) {
    ...
    private class AppListAdapter extends BaseAdapter implements SectionIndexer, Filterable {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                ...
                viewHolder.mAppPackage = convertView.findViewById(R.id.appPackage);
                viewHolder.mAppIcon = convertView.findViewById(R.id.appIcon);
