...
public class ColorPickerDialog
    ...
    public interface OnColorChangedListener {
        void onColorChanged(int color, boolean put);
    }
    ...
    private void setUp(int color) {
        ...
        mLayout = inflater.inflate(R.layout.dialog_color_picker, parent, false);
    ...
    private void updateHexValue(int color) {
        if (getAlphaSliderVisible()) {
            mHexVal.setText(ColorPickerPreference.convertToARGB(color).toUpperCase(Locale
                    .getDefault()));
        } else {
            mHexVal.setText(ColorPickerPreference.convertToRGB(color).toUpperCase(Locale
                    .getDefault()));
        }
        mHexVal.setTextColor(mHexDefaultTextColor);
    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.new_color_panel) {
            if (mListener != null) {
                mListener.onColorChanged(mNewColor.getColor(), true);
            }
        }
        dismiss();
    }
